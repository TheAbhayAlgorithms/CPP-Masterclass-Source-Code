...
int main() {
    ...
    // Using signed doesn't gonna change anything because it allows both positive and negative integers to store
    signed int value3{10};
    signed int value4{-1900};
    cout << "Value 3: " << value3<<endl;
    cout <<"Value 4: " << value4<<endl;
    cout <<"Size of value 3: " << sizeof(value3) << endl;
    cout <<"Size of value 4: " << sizeof(value4) << endl;


    unsigned int value5{10};
    // unsigned int value6{-1900}; // Compilation error, because unsigned allows only positive values to be stored
